...
class Small_Form {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Small_Form_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SMALL_FORM_VERSION' ) ) {
			$this->version = SMALL_FORM_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * Uses the Small_Form_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Small_Form_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Small_Form_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Small_Form_Loader    Orchestrates the hooks of the plugin.
	 */
